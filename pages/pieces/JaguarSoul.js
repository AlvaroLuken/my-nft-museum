      ...
      <Flex mt={12} direction='row' justifyContent='space-around'>
        ...
        <Center>
          <NextLink href="/pieces/JaguarSoulImage">
            <Image cursor='pointer' mt={8} pb={16} boxSize='420px' src="https://media.niftygateway.com/image/upload/q_auto:good,w_800/v1595942803/CarlosMarcial/Ai_Jaguar_previz_ah5kbf.webp" />
          </NextLink>
        </Center>
      </Flex>
    </Layout>
