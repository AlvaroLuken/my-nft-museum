  ...
  return (
    <Layout title="Jaguar's Soul">
      ...
      <Flex mt={12} direction='row' justifyContent='space-around'>
        ...
        <b>Jaguar's Soul</b> was my first major NFT purchase. This was a piece I saved up for and was nervous about pulling the trigger. Not for any reason related to the piece, but because I had never spent such a large amount of money to buy really... anything. Maybe my car. So I learned to play the art game like the high rollers do and pulled the trigger.
        <br></br><br></br>
        ...
        <div style={{display: 'flex', flexDirection: 'column'}}>
          <NextLink href="/pieces/JaguarSoulImage">
            <Image style={{marginRight: "1.6rem"}} cursor='pointer' mt={8} pb={16} boxSize='620px' src="https://media.niftygateway.com/image/upload/q_auto:good,w_800/v1595942803/CarlosMarcial/Ai_Jaguar_previz_ah5kbf.webp" />
          </NextLink>
          <Center>
